...
export const projects: ResumeProject[] = [
  ...
  },
  {
    ...
    description: "Built a desktop-first customer and business management system for Guide Motor Training School to streamline daily operations, student/customer records, process tracking, and administrative workflows across the organization.",
    techStack: ["Electron.js", "HTML", "CSS", "JavaScript", "Node.js", "Express.js", "SQLite3", "Windows Installer", "Mac DMG", "Linux AppImage", "SMS API"],
    links: [
      { label: "Details", url: "https://algodevopss.in/projects/guide-mts" },
  ...
  },
  {
    ...
    description: "Developed a WhatsApp chatbot solution for Mumbai Police to support complaint registration and structured information sharing with citizens through an accessible conversational interface.",
    techStack: ["Next.js", "Meta", "LLM", "WhatsApp API", "Next.js", "Node.js", "Express.js", "MongoDB", "Hostinger VPS"],
    links: [
      { label: "Details", url: "https://algodevopss.in/projects/whatsapp-chatbot-mumbai-police" },
    ],
  ...
  },
  {
    ...
    description: "Built the corporate website for AY Techinsight, a service-based IT software company with multiple in-house business verticals. The platform communicates core services, company capabilities, and internship opportunities where students can gain hands-on experience by working on live projects.",
    techStack: ["React.js", "CSS", "JavaScript", "Node.js", "MySQL", "Hostinger"],
    links: [
      { label: "Details", url: "https://algodevopss.in/projects/aytechinsight" },
  ...
  },
  {
    ...
    description: "Built TaxPeCharcha as a tax-focused blogging web application for publishing practical updates and insights. The platform is structured around three core categories: Income Tax, GST, and Customs, making it easy for readers to find relevant topic-wise content.",
    techStack: ["HTML", "CSS", "JavaScript", "PHP", "MySQL", "Hostinger"],
    links: [
      { label: "Details", url: "https://algodevopss.in/projects/taxpecharcha" },
    ...
    links: [
      { label: "Details", url: "https://algodevopss.in/projects/ves-polytechnic-app" },
  ...
  },
  {
    ...
    description: "Designed and developed the first version of DJ Ganesh's official website to establish his digital identity and event presence. The site introduced his DJ profile, service offerings, and performance style for weddings, corporate events, and private celebrations, laying the foundation for later platform upgrades.",
    techStack: ["HTML", "CSS", "JavaScript", "GoDaddy", "Hostinger"],
    links: [
      { label: "Details", url: "https://algodevopss.in/projects/djgsonyyyyy-v1" },
